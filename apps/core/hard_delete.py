...
----------------
    ...
    from apps.core.hard_delete import CanHardDelete
...
class HardDeleteGuard(models.Model, metaclass=HardDeleteGuardMeta):
    ...
    def hard_delete(  # type: ignore[override]
        ...
        # Delegate to Django's real Model.delete() — bypasses SoftDeleteModel.
        result = super().hard_delete(using=using, keep_parents=keep_parents)  # type: ignore[misc]
