...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "family_name",
                    models.CharField(
                        db_index=True, help_text="Family / last name.", max_length=200
                    ),
                ),
                (
                    "given_names",
                ...
                (
                    "deceased_date",
                    models.DateField(
                        blank=True, help_text="Date of death if applicable.", null=True
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=1, help_text="Preferred order (1 = highest priority)."
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="patient",
            index=models.Index(
                fields=["family_name", "birth_date"],
                name="patients_pa_family__d855d8_idx",
            ),
        ),
